...
const LoadingAnimation: React.FC<LoadingAnimationProps> = ({
    ...
    return (
        <div
            className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-background transition-opacity duration-800 ${isExiting ? 'opacity-0' : 'opacity-100'}`}
        ...
        >
            <div className="w-full max-w-sm px-4 sm:px-0 flex flex-col items-center">
                ...
                <div className="relative mb-8 w-24 h-24">
                    ...
                    <div className="absolute inset-0 border-4 border-primary/30 rounded-md animate-spin-slow" style={{ animationDirection: 'reverse' }} />
