...
const HeadingRender: React.FC<HeadingRenderProps> = ({ level, ...props }) => {
  const headingStyles = {
    1: "text-6xl font-bold mt-10 mb-4 text-white group flex items-center",
    2: "text-4xl font-semibold mt-8 mb-3 text-gray-100 group flex items-center",
    3: "text-2xl font-normal mt-6 mb-3 text-gray-200 group flex items-center",
  };
