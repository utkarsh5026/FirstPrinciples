    ...
    case "th":
      return (
        <th
          ...
          className="px-2 xs:px-3 sm:px-4 py-2 xs:py-2.5 sm:py-3 text-left text-xs xs:text-sm font-medium text-foreground uppercase tracking-wide xs:tracking-wider break-words"
        />
      );
    case "td":
      return (
        <td
          ...
          className="px-2 xs:px-3 sm:px-4 py-2 xs:py-2.5 sm:py-3 text-xs xs:text-sm sm:text-base text-foreground break-words leading-5 xs:leading-6 sm:leading-7"
        />
      );
    default:
      return null;
