...
const ParagraphRender: React.FC<React.ComponentPropsWithoutRef<"p">> = (
  ...
  return (
    <p
      {...props}
      className="text-foreground my-3 xs:my-4 sm:my-5 leading-6 xs:leading-7 sm:leading-8 text-pretty break-words text-base xs:text-base sm:text-lg px-1 xs:px-0"
    />
  );
};
