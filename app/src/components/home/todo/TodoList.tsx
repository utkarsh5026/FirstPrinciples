...
import { ListTodo, Plus, CheckCircle2, X, Calendar } from "lucide-react";
              ...
              {todoList
                ...
                .map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      <button
                        className="text-left text-sm font-medium text-muted-foreground line-through hover:text-primary transition-colors line-clamp-1 w-full"
                        onClick={() =>
                          handleSelectDocument(item.path, item.title)
                        }
                      >
