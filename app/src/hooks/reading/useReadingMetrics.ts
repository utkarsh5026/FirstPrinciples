...
/**
 * Single source of truth for reading metrics
 *
 * This hook centralizes all reading metrics from the section reading system
 * and provides a unified interface for accessing metrics across the application.
 */
